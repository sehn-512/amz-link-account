 ...
 */
public class ResponsePaymentPaymentInsightsInformationResponseInsights implements Serializable {
	
	public ResponsePaymentPaymentInsightsInformationResponseInsights() {
		super();
	}
