 ...
 */
public class ResponseReversalPointOfSaleInformation implements Serializable {
	
	public ResponseReversalPointOfSaleInformation() {
		super();
	}
	...
	ResponseReversalPointOfSaleInformationEmv emv;

	public ResponseReversalPointOfSaleInformationEmv getEmv() {
		return emv;
	}

	public void setEmv(ResponseReversalPointOfSaleInformationEmv emv) {
		this.emv = emv;
	}
