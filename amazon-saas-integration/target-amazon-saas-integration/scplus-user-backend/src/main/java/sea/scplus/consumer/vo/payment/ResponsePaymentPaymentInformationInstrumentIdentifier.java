 ...
 */
public class ResponsePaymentPaymentInformationInstrumentIdentifier implements Serializable {
	
	public ResponsePaymentPaymentInformationInstrumentIdentifier() {
		super();
	}
