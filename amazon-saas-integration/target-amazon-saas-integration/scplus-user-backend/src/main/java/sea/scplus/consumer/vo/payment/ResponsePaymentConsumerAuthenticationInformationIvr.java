 ...
 */
public class ResponsePaymentConsumerAuthenticationInformationIvr implements Serializable {
	
	public ResponsePaymentConsumerAuthenticationInformationIvr() {
		super();
	}
	...
	boolean enabledMessage;
	
	@JsonInclude(value = Include.NON_NULL)
	String encryptionKey;
	
	@JsonInclude(value = Include.NON_NULL)
	boolean encryptionMandatory;
