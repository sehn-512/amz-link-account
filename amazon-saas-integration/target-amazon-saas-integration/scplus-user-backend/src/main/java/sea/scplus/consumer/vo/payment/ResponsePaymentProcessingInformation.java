 ...
 */
public class ResponsePaymentProcessingInformation implements Serializable {
	
	public ResponsePaymentProcessingInformation() {
		super();
	}
	...
	@JsonInclude(value = Include.NON_NULL)
	ResponsePaymentProcessingInformationBankTransferOptions bankTransferOptions;
	...
	public ResponsePaymentProcessingInformationBankTransferOptions getBankTransferOptions() {
		return bankTransferOptions;
	}

	public void setBankTransferOptions(ResponsePaymentProcessingInformationBankTransferOptions bankTransferOptions) {
