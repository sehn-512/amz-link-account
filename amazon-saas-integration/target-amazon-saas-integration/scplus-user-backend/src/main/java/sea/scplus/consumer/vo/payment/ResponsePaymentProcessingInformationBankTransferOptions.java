 ...
 */
public class ResponsePaymentProcessingInformationBankTransferOptions implements Serializable {
	
	public ResponsePaymentProcessingInformationBankTransferOptions() {
		super();
	}
