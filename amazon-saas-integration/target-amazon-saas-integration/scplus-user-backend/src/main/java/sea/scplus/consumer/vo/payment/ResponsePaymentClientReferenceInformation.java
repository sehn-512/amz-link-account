 ...
 */
public class ResponsePaymentClientReferenceInformation implements Serializable {
	
	public ResponsePaymentClientReferenceInformation() {
		super();
	}
	...
	@JsonInclude(value = Include.NON_NULL)
	String 	submitLocalDateTime;
	
	@JsonInclude(value = Include.NON_NULL)
	String 	ownerMerchantId;
