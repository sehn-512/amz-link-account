...
public class RequestTicket implements Serializable {
	...
	@JsonInclude(value = Include.NON_NULL)
//	private List<RequestNSACompleteCategoryData> category_list;
...
//	public List<RequestNSACompleteCategoryData> getCategory_list() {
//		return category_list;
//	}
//
//	public void setCategory_list(List<RequestNSACompleteCategoryData> category_list) {
//		this.category_list = category_list;
//	}
