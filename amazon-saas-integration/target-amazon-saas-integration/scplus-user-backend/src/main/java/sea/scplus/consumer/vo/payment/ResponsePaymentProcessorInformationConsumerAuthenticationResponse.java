 ...
 */
public class ResponsePaymentProcessorInformationConsumerAuthenticationResponse implements Serializable {
	
	public ResponsePaymentProcessorInformationConsumerAuthenticationResponse() {
		super();
	}
