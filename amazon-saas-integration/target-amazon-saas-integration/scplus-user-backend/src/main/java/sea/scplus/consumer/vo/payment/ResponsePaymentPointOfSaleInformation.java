 ...
 */
public class ResponsePaymentPointOfSaleInformation implements Serializable {
	
	public ResponsePaymentPointOfSaleInformation() {
		super();
	}
	...
	ResponsePaymentPointOfSaleInformationEmv emv;
	...
	public ResponsePaymentPointOfSaleInformationEmv getEmv() {
		return emv;
	}

	public void setEmv(ResponsePaymentPointOfSaleInformationEmv emv) {
		this.emv = emv;
	}
